...
builder.Services.AddHostedService<FundooNotesApp.API.BackgroundServices.ReminderConsumerService>();
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Backend API for FundooNotesApp - user auth, notes, tags, trash, and search"
    });
    ...
    // Include XML comments (summary/param/response tags from controllers) in Swagger UI
